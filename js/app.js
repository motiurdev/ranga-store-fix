...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <div class="d-flex justify-content-center" style="color:#2b3648">
        <p class="me-4">Rating: ${product.rating.rate}</p>
